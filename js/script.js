(function () {
  ...
  //função que dá inicio ao jogo embaralhando o array e desabilitando a tela inicial
  function startGame() {
  ...
  //função para ajustar a posição da peça clicada dentro do array
  function moveTile() {
    ...
    //função game over que finaliza o jogo após os numeros estarem organizados em ordem crescente
    function gameOver() {
